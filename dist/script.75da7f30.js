...
function setWeatherData(data) {
  var place = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : data.timezone.split('/')[1].replace(/_/g, " ");
...
searchBox.addListener('places_changed', function () {
  ...
  fetch("https://dark-sky.p.rapidapi.com/".concat(lat, ",").concat(long, "?lang=en&units=auto"), {
    "method": "GET",
    "headers": {
